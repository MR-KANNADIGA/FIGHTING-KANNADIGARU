RAID = [
    "TOXIC SIR AND PROFESSOR SIR KO BOLTE HAI OP AND TU INLOGO KE LUND KE TOPI",
    "MADARCHOD TERI MAA KI CHUT ME PROFESSOR GHUTKA KHAAKE THOOK DENGE🤣🤣",
    "TERE BEHEN K CHUT ME TOXIC CHAKU DAAL KAR CHUT KA KHOON KAR DENGE",
    "TERE MAA AND BEHAN KO TOXIC SIR AND PROFESSOR SIR MILKE CHOD RAHE HAI",
...
RRAID = [
    "NIMOUN TULLAG TUNNI",
    "NIM DODDAMMA TULLAG TUNNI",
    "NIM CHIKKAMMA TULLAG TUNNI",
    "NIM AKKA NA TULLAG TUNNI ",
    "NIM TANGI TULLAG TUNNI..",
    "NIM TEACHER TULLAG TUNNI..",
    "NIM AVVAN TULLAG UPPINKAI HAAKI NEKKTEN.",
    "NIM AVVAAN KARI TULLAG NANN KEMP TUNNI HAKTEN",
    "NIM AVVAN TULLAG TUPPA HAAKI TAPA TAPA HADTEN?",
    "SULI MAGA NI",
    "RANDI MAGA NI.",
    "NIM AVVAN TULL EN BANGARA AITI EN",
    "NIM AVVAN TULLAG PROFESSOR SIR DA TUNNI",
    "NIM AKKAN TULLAG AGORA SIR TUNNI..",
    "NIM TANGI TULLAG POGARU HUDUGA NA TUNNI",
    "NIM DODDAMMA NA TULLAG SANKI FIGHTER DA TUNNI",
    "NIM TEACHER TULLAG ROCKSTAR TUNNI",
    "NIM AKKAN TULLAG KAAGI HETET EN LE",
    "NIM AKKAN TULL GUBBI GUUUD IDDANG AIT KARKOND BAA NANN KADE AGSI BAAGIL MADTEN",
    "NIM AVVAN TULLAG KUNTA KONA MUKA JAANA NATAKA NODTEN",
    "NIM AVVA HUCH RANDI ",
    "NIMOUN TULL KANNADAG MATAD ILANDRA NIM AVVAN MUKLYAG BADGI TURAKTEN NOD",
